...
.tech-glow-orb {
  background: radial-gradient(
    ...
    color-mix(in oklch, var(--secondary) 5%, transparent) 40%,
    transparent 70%
  );
}
...
.footer-giant-bg-text {
  font-size: clamp(10rem, 18.4vw, 100vw);
  line-height: 0.75;
  font-weight: 900;
...
export function MinimalTechFooter  () {
        ...
        <footer className="cinematic-footer-wrapper fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground">
            ...
            <div ref={linksRef} className="flex w-full flex-col items-center gap-6">
              <div className="flex w-full flex-wrap justify-center gap-4">
                <MagneticButton 
                  ...
                  className="footer-glass-pill flex items-center gap-3 rounded-full px-10 py-5 text-sm font-bold text-foreground md:text-base group"
                >
              ...
              <MagneticButton
                ...
                target="_blank"
                className="tech-link-hover text-m font-medium text-tech-text-muted hover:text-foreground"
              >
                GitHub
              </MagneticButton>
          ...
          <div className="relative z-20 flex w-full flex-col items-center justify-between gap-6 px-6 pb-8 md:flex-row md:px-12">
            ...
            <MagneticButton
              as="button"
              onClick={scrollToTop}
              className="footer-glass-pill flex h-12 w-12 items-center justify-center rounded-full text-muted-foreground hover:text-foreground order-3 group"
            >
